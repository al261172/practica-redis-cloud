...
from .modelo_usuario import (crear_usuario_json, leer_usuario_json, actualizar_usuario_json, eliminar_usuario, listar_usuarios,)


# Cargar variables de entorno desde .env para asegurar REDIS_URL
load_dotenv()

# Definición de rutina para imprimir el objeto json resultante de las llamadas
...
# Creación de función para solicitar el json que contiene el valor a almacenar

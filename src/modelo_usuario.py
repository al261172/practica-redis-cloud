...
#Normalizar el id_usuario a string
...
#Definir función para crear registro mediante el set
...
# Definir función para lectura de usuario mediante get
...
# Definir la actualización del usuario permitiendo mezclar o reemplazar el
# contenido del json
...
# Crear la eliminación del registro mediante delete
...
# Definición del listado de usuarios mediante un ciclo de los elementos
# encontrados con keys
